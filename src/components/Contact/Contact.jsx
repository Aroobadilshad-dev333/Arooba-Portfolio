...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_i7osik7",  // Replace with your EmailJS Service ID
        "template_y337cuj",  // Replace with your EmailJS Template ID
        form.current,
        "cNoFW1VgBng1wN34Y"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          Ready to collaborate and bring innovative ideas to life. 
