    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Arooba</span>
          <span className="text-[#3b82f6]">/</span>
          <span className="text-white">Dilshad</span>
          <span className="text-[#3b82f6]">&gt;</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/Aroobadilshad-dev333 "
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/arooba-dilshad-885646374"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#3b82f6]"
          >
